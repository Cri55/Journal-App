...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //populate the list with svae entries
...
//                        .setAction("Action", null).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.entries) {
            getFragmentManager().beginTransaction().
                    replace(R.id.content_frame,new ListFragment()).commit();
            // Handle each action
            ...
            Intent account =new Intent(MainActivity.this, LogOut.class);
            startActivity(account);
        }  {
            //Code already shows entries when entries is clicked
        }
    ...
    public void setDetails(GoogleSignInResult result) {
